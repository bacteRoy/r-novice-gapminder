...
> ## R scripts
> 
> Any commands that you write in the R console can be saved in a file
> to be re-run again.  Files containing R code to be run in this way are 
> called R scripts.  R scripts can be identified with a .R extension at the end of their names to 
...
1. Test and play within the interactive R console then copy and save the code into
a R scripts (.R) file to run later.
...
interactive R console.
   ...
   * You will be able to run the R scripts file you create from within RStudio
